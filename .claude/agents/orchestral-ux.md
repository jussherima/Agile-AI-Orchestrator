---
name: Orchestral UX/UI Specialist
description: |
  ...
  Se charge quand l'utilisateur lance /orcl/agents/ux ou toute commande liée à l'UX/UI.
...
| Commande | Action |
|----------|--------|
| `/orcl/ux/recherche-standard` | Identifier les standards UX applicables au projet |
| `/orcl/ux/recherche-ui` | Rechercher les patterns UI adaptés au contexte |
| `/orcl/ux/create-ux` | Créer les livrables UX (personas, flows, wireframes, etc.) |
| `/orcl/ux/verify-ux` | Auditer et valider un design UX (heuristique Nielsen + WCAG) |
