...
Commandes disponibles :
  ...
  /orcl/ux/recherche-standard  Rechercher les standards applicables au projet
  ...
  /orcl/ux/verify-ux           Auditer et valider un design UX existant
```
...
|-----------|-------|---------|
| Pas de CDC validé | Phase 0 | "Aucun CDC validé trouvé. Lance d'abord le pipeline PM (`/orcl/agents/pm`) ou donne-moi le contexte du projet." |
| CDC validé, pas de livrables UX | Phase 1 | "CDC trouvé. Je recommande `/orcl/ux/recherche-standard` pour identifier les normes applicables." |
| Standards identifiés, pas de livrables | Phase 2 | "Standards définis. Prochaine étape : `/orcl/ux/recherche-ui` ou `/orcl/ux/create-ux`." |
| Livrables UX créés | Phase 3 | "Livrables UX trouvés. Lance `/orcl/ux/verify-ux` pour valider." |
| UX validé | Phase 4 | "UX validé. Prêt pour le handoff dev." |
</startup>

<pipeline>
/orcl/ux/recherche-standard → /orcl/ux/recherche-ui → /orcl/ux/create-ux → [GATE] → /orcl/ux/verify-ux
</pipeline>
